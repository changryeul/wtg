...
set -u
NAMES=(mci-admin mci-api mci-price mci-edge-price mci-edge-api mci-edge-fix-ord mci-edge-fix-md mci-edge-tcp mci-push mci-edge-push mci-chart quote-forwarder prometheus wtg-dev-tickloop load-gen)
