...
set -u
NAMES=(mci-admin mci-api mci-price mci-edge-price mci-edge-api mci-edge-fix-ord mci-edge-fix-md mci-edge-tcp mci-push mci-edge-push mci-chart mci-price-krx quote-forwarder prometheus wtg-dev-tickloop load-gen)
...
check "mci-edge-fix-ord /stats"       "http://127.0.0.1:5002/stats"          mci-edge-fix-ord
check "mci-edge-fix-ord /metrics"     "http://127.0.0.1:5002/metrics"        mci-edge-fix-ord
check "mci-edge-fix-md /stats"        "http://127.0.0.1:5012/stats"          mci-edge-fix-md
check "mci-edge-fix-md /metrics"      "http://127.0.0.1:5012/metrics"        mci-edge-fix-md
